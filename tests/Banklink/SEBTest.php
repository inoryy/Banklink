...
class SEBTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testPreparePaymentRequestWithStringKeys()
    {
        ...
        $protocol = new iPizza(
            ...
            'Test Testov',
            '119933113300',
            file_get_contents(__DIR__.'/data/iPizza/private_key.pem'),
            file_get_contents(__DIR__.'/data/iPizza/public_key.pem'),
            'http://www.google.com'
        );
